...
```bash
# Set this to the active runtime's skill directory.
...
- `./bin/yarli-lint-implementation-plan.sh <plan-file>`
  - Fallback: `$RAHULSKILLS_HOME/bin/yarli-lint-implementation-plan.sh`
- Optional: `./bin/yarli-sanitize-continuation.sh`
  - Fallback: `$RAHULSKILLS_HOME/bin/yarli-sanitize-continuation.sh`
